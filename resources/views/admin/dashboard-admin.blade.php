...
<div class="py-12">
    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8" style="padding-left: 5%">
        <div class="card-container">
            ...
            <a href="#" class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 uniform-card">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Number of Supervisor</h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">{{$svCount}}</p>
            </a>
            <a href="#" class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 uniform-card">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Number of PM</h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">{{$pmCount}}</p>
            </a>
            <a href="#" class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 uniform-card">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Number of SHO</h5>
    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8" style="padding-left: 5%">
        ...
        <div class="card-container1" style="margin-top: 3%">
            <a href="#" class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 uniform-card">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">HIRARC</h5>
            ...
            <a href="#" class="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 uniform-card">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Incidents</h5>
