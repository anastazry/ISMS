                  ...
                  <table id="hirarcTable" class="min-w-full text-left text-sm font-light">
                    <thead
                      ...
                      <tr>
                        ...
                        <th scope="col" class="px-5 py-4">Part A</th>
                        <th scope="col" class="px-5 py-4">Part B</th>
                        <th scope="col" class="px-5 py-4">Print</th>
                      </tr>
                    </thead>
                    <tbody>
                      @php($i=0)
...
>
                        ...
                        onclick="showIncidentDetails(this)"
                        >
                          @if ($incident->investigationstatus == "set")
                        ...
                        <td>
                          @if ($incident->investigationstatus == "set")
                            <a href="{{ route('update-incident-investigation-form', ['reportNo' => $incident->reportNo]) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Update</a>

                          @else
                            <a href="{{ route('incident-investigation-form', ['reportNo' => $incident->reportNo]) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Start</a>
                          @endif
                        </td>
                        <td>
                        ...
                        <td>
                          <a href="{{ route('print-investigation-report', ['reportNo' => $incident->reportNo]) }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded">Print</a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
